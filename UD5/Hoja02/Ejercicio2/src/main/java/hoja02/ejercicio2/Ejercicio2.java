...
public class Ejercicio2 {
    ...
    public static void main(String[] args) {
        ...
        articulos[7] = new EnPromocion(3.9, 8, 20, "compra");
        articulos[8] = new EnPromocion(2.9, 9, 20, "compra");
        articulos[9] = new EnPromocion(2.9, 10, 20, "compra");

        for (Articulo articulo : articulos) {
            System.out.println(articulo.toString());
        }
        Perecedero.caducados(articulos);
        System.out.println(EnPromocion.Promocion(articulos));
